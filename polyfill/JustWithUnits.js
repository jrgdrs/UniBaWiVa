...
var JustWithUnits = (function () {
  ...
  function JustWithUnits ( querySelection, userConfig ) {
    ...
    theStyle.innerHTML = '.cssClass { color: #f00; } @font-face { font-family: TESTFONT; src: url(../development/OH.ttf); } body { font-family: TESTFONT; font-variation-settings: "wght" 300, "xtra" 300, "wdth" 100; } .line { display: flex; justify-content: space-between; position: relative; } .align-justify .line { justify-content: space-between; text-indent: 0; } .align-center .line { justify-content: center; } .align-left .line { justify-content: flex-start; } .align-right .line { justify-content: flex-end; } .align-justify .line:last-child, .align-left .line:last-child, .align-right .line:last-child { justify-content: flex-start; __background-color: white; } .align-right .line:last-child { justify-content: flex-end; } .line:last-child { justify-content: flex-start; } .word { __background-color: white; white-space: nowrap; text-indent: 0; } .space { __background-color: white; min-width: 0; text-indent: 0; } .hyphen { __background-color: white; text-indent: 0; } .pone { font-variation-settings: "wght" 300, "xtra" 300, "wdth" 110; color: var(--unitizedColor); }';
